...
/* harmony default export */ __webpack_exports__["a"] = (function () {
  ...
  }, "Starbucks")), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_semantic_ui_react__["f" /* Menu */].Menu, {
    position: "right",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11
...
var _jsxFileName = "/Users/yuxu/Desktop/work/nodeJS/su18-cmpe202-got/su18-202-got/express_server/bc_server/pages/homes/main.js";
...
/*#__PURE__*/
function (_Component) {
  _inherits(StarbucksIndex, _Component);

  function StarbucksIndex() {
    _classCallCheck(this, StarbucksIndex);

    return _possibleConstructorReturn(this, (StarbucksIndex.__proto__ || Object.getPrototypeOf(StarbucksIndex)).apply(this, arguments));
  }

  _createClass(StarbucksIndex, [{
    key: "renderUser",
    value: function renderUser() {
      var items = [{
        header: this.props.user[2],
        description: "Email: ".concat(this.props.user[1]),
        meta: "Ethereum ID: ".concat(this.props.accounts),
        fluid: true
      }, {
        header: this.props.card[0],
        description: "Balance: ".concat(this.props.card[2]),
        meta: "",
        fluid: true
      }];
    ...
    value: function render() {
      ...
      }, "Welcome to Starbucks!"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__routes__["Link"], {
        route: "/homes/new",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 43
    ...
    value: function () {
      ...
      __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee() {
        var accounts, user, card;
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return __WEBPACK_IMPORTED_MODULE_3__ethereum_web3___default.a.eth.getAccounts();

              case 2:
                accounts = _context.sent;
                console.log(accounts);
                _context.next = 6;
                return __WEBPACK_IMPORTED_MODULE_4__ethereum_users___default.a.methods.findSelf().call({
                  from: accounts[0]
                });
              ...
              case 6:
                user = _context.sent;
                _context.next = 9;
                return __WEBPACK_IMPORTED_MODULE_4__ethereum_users___default.a.methods.showCard().call({
                  from: accounts[0]
                });
  ...
  return StarbucksIndex;
}(__WEBPACK_IMPORTED_MODULE_1_react__["Component"]);

/* harmony default export */ __webpack_exports__["default"] = (StarbucksIndex);
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/homes/main")
...
routes.add('/homes/main', '/homes/main').add('/homes/new', '/homes/new').add('/homes/pay', '/homes/pay').add('/homes/rewards', '/homes/rewards').add('/homes/store', '/homes/store').add('/api/logout', '/api/logout');
module.exports = routes;

/***/ })

})
//# sourceMappingURL=4.5a8f22dfa0e93f3b3c67.hot-update.js.map